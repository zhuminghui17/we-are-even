...
import 'a5_onboarding_model.dart';
export 'a5_onboarding_model.dart';

class A5OnboardingWidget extends StatefulWidget {
  const A5OnboardingWidget({Key? key}) : super(key: key);

  @override
  _A5OnboardingWidgetState createState() => _A5OnboardingWidgetState();
}

class _A5OnboardingWidgetState extends State<A5OnboardingWidget> {
  late A5OnboardingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => A5OnboardingModel());
  }
