...
import 'a1_register_account_model.dart';
export 'a1_register_account_model.dart';

class A1RegisterAccountWidget extends StatefulWidget {
  const A1RegisterAccountWidget({Key? key}) : super(key: key);

  @override
  _A1RegisterAccountWidgetState createState() =>
      _A1RegisterAccountWidgetState();
}

class _A1RegisterAccountWidgetState extends State<A1RegisterAccountWidget> {
  late A1RegisterAccountModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => A1RegisterAccountModel());
                              ...
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    context.goNamedAuth(
                                        'a2-completeProfile', context.mounted);
                                  },
