...
import 'c2_expense_edit_model.dart';
export 'c2_expense_edit_model.dart';

class C2ExpenseEditWidget extends StatefulWidget {
  const C2ExpenseEditWidget({
    Key? key,
  ...
  @override
  _C2ExpenseEditWidgetState createState() => _C2ExpenseEditWidgetState();
}

class _C2ExpenseEditWidgetState extends State<C2ExpenseEditWidget>
    with TickerProviderStateMixin {
  late C2ExpenseEditModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => C2ExpenseEditModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<TransactionsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final c2ExpenseEditTransactionsRecord = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: FlutterFlowTheme.of(context).tertiary,
          body: Form(
                          ...
                          Padding(
                            ...
                            child: TextFormField(
                              controller: _model.textController1 ??=
                                ...
                                text: c2ExpenseEditTransactionsRecord
                                    .transactionAmount,
                              ),
                              obscureText: false,
                          ...
                          StreamBuilder<List<BudgetsRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              return FFButtonWidget(
                                onPressed: () async {
                                  await c2ExpenseEditTransactionsRecord
                                      .reference
