...
import 'a2_complete_profile_model.dart';
export 'a2_complete_profile_model.dart';

class A2CompleteProfileWidget extends StatefulWidget {
  const A2CompleteProfileWidget({Key? key}) : super(key: key);

  @override
  _A2CompleteProfileWidgetState createState() =>
      _A2CompleteProfileWidgetState();
}

class _A2CompleteProfileWidgetState extends State<A2CompleteProfileWidget> {
  late A2CompleteProfileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => A2CompleteProfileModel());
                ...
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      ...
                      context.pushNamed('a5-onboarding');
                    },
