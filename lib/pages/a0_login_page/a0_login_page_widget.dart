...
class A0LoginPageWidget extends StatefulWidget {
  const A0LoginPageWidget({Key? key}) : super(key: key);

  @override
  _A0LoginPageWidgetState createState() => _A0LoginPageWidgetState();
}
                                ...
                                children: [
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      'o07j3mgv' /* Welcome to We're Even */,
                                    ),
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        context.pushNamed('a7-forgotPassword');
                                      },
                              ...
                              Row(
                                ...
                                children: [
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      context.pushNamed('a1-registerAccount');
                                    },
                                    child: Container(
