...
import 'a3_edit_profile_model.dart';
export 'a3_edit_profile_model.dart';

class A3EditProfileWidget extends StatefulWidget {
  const A3EditProfileWidget({
    Key? key,
    this.userProfile,
  }) : super(key: key);
  ...
  @override
  _A3EditProfileWidgetState createState() => _A3EditProfileWidgetState();
}

class _A3EditProfileWidgetState extends State<A3EditProfileWidget> {
  late A3EditProfileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => A3EditProfileModel());
  }
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final a3EditProfileUsersRecord = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: FlutterFlowTheme.of(context).secondaryBackground,
          appBar: AppBar(
              ...
              child: Column(
                ...
                children: [
                    ...
                    child: Container(
                      ...
                      child: Image.network(
                        valueOrDefault<String>(
                          a3EditProfileUsersRecord.photoUrl,
                    ...
                    child: StreamBuilder<List<UsersRecord>>(
                      stream: queryUsersRecord(
                        queryBuilder: (usersRecord) => usersRecord.where('uid',
                            isEqualTo: a3EditProfileUsersRecord.reference.id),
                        singleRecord: true,
                      ),
                      builder: (context, snapshot) {
                        // Customize what your widget looks like when it's loading.
                        ...
                        return TextFormField(
                          controller: _model.yourNameController ??=
                            ...
                            text: a3EditProfileUsersRecord.displayName,
                          ),
                          obscureText: false,
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      controller: _model.yourEmailController ??=
                          TextEditingController(
                        text: a3EditProfileUsersRecord.email,
                      ),
                      obscureText: false,
                      decoration: InputDecoration(
                        labelText: FFLocalizations.of(context).getText(
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      controller: _model.yourAgeController ??=
                          TextEditingController(
                        text: a3EditProfileUsersRecord.age.toString(),
                      ),
                      obscureText: false,
                      decoration: InputDecoration(
                        labelText: FFLocalizations.of(context).getText(
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      controller: _model.yourTitleController ??=
                          TextEditingController(
                        text: a3EditProfileUsersRecord.userTitle,
                      ),
                      obscureText: false,
                      decoration: InputDecoration(
                        labelText: FFLocalizations.of(context).getText(
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await a3EditProfileUsersRecord.reference
