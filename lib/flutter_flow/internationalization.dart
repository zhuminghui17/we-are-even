...
final kTranslationsMap = <Map<String, Map<String, String>>>[
  ...
  // d0-homePage
  {
    ...
    '30yef7fj': {
      'en': 'Create/Search Groups',
      'ar': 'الرواتب المستحقة',
      'de': 'Gehaltsabrechnung fällig',
      'es': 'Vencimiento de nómina',
    },
    '0g6nmx48': {
      'en': 'Go to Your Groups',
      'ar': 'الرواتب المستحقة',
      'de': 'Gehaltsabrechnung fällig',
      'es': 'Vencimiento de nómina',
    },
    'lmo3ko2i': {
      'en': 'View Your Friends',
      'ar': 'خدمات سريعة',
      'de': 'Schnelle Dienste',
  ...
  // a9-CreatedGroupSuccess
  {
    ...
    'm02m63sl': {
      'en': 'Thanks for creating the group!',
      'ar': '',
      'de': '',
      'es': '',
    },
  ...
  // joinGroups
  {
    ...
    'c1cf0eea': {
      'en': 'Enter your customized group ID....',
      'ar': 'أدخل بريدك الإلكتروني ...',
      'de': 'Geben sie ihre E-Mail Adresse ein...',
      'es': 'Introduce tu correo electrónico...',
    },
    ...
    'uayy955d': {
      'en': 'Enter your group description...',
      'ar': 'أدخل بريدك الإلكتروني ...',
      'de': 'Geben sie ihre E-Mail Adresse ein...',
      'es': 'Introduce tu correo electrónico...',
    },
    ...
    'r3xh73jl': {
      'en': 'Or search a group...',
      'ar': '',
      'de': '',
      'es': '',
    },
    'nh4cy396': {
      'en': 'Enter group name to search ...',
      'ar': '',
      'de': '',
      'es': '',
    },
    '4a8ie52a': {
      'en': 'Groups matching search',
      'ar': '',
      'de': '',
      'es': '',
    },
  ...
  {
    '260khcba': {
      'en': 'Enter your friends\' email to search',
      'ar': '',
      'de': '',
      'es': '',
    },
    'v5uqpbfy': {
      'en': 'User matching search',
      'ar': '',
      'de': '',
      'es': '',
    },
